...
class PlanningGraph():
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for precond_of_a1 in node_a1.parents:
            for precond_of_a2 in node_a2.parents:
                if precond_of_a1.is_mutex(precond_of_a2):
                    return True
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for precond_of_s1 in node_s1.parents:
            for precond_of_s2 in node_s2.parents:
                if not precond_of_s1.is_mutex(precond_of_s2):
                    return False
